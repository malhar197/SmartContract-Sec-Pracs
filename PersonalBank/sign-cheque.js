...
async function signPayment() {
    ...
    // contract address declared
    let contractAddress = '0xdd31d4fE496B0134462E029B8110A45b7439f189';

    let message = ethers.utils.concat([
                      ethers.utils.hexZeroPad(to, 20),
                      ethers.utils.hexZeroPad(ethers.utils.hexlify(amountWei), 32),
                      //contract address included for preventing cross-contract spend attacks
                      contractAddress,
                  ]);
